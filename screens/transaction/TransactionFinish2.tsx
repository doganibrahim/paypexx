...
const TransactionFinish2: React.FC<TransactionFinishProps> = ({ navigation, route }) => {
  const [toastVisible, setToastVisible] = useState(false);

  const bankDetails = {
    bankName: 'Geçici',
    accountName: 'PayPexx Sınırlı',
    cardNumber: '1234 1234 5678 9012',
...
export default TransactionFinish2;