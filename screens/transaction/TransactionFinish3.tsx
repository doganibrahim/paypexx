...
const TransactionFinish3: React.FC<TransactionFinishProps> = ({ navigation, route }) => {
              ...
              <View key={key} style={styles.detailRow}>
                <Text style={styles.label}>
                  {key === 'bankName' ? 'Banka Adı' :
                   ...
                   key === 'sortCode' ? 'Sort Code' :
                   key === 'accountNumber' ? 'Account Code' :
...
export default TransactionFinish3;