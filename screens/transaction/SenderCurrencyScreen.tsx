...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'SenderCurrency'>;

const SenderCurrencyScreen = () => {
    const navigation = useNavigation<NavigationProp>();
    const { setSenderCurrency } = useCurrency();
    const [searchQuery, setSearchQuery] = useState('');

    const filteredCurrencies = useMemo(() => {
        return senderCurrencies.filter((item: Currency) => 
...
export default SenderCurrencyScreen;